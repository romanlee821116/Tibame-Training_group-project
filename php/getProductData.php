...
$pdo = getPDO();
$pagecount = $pdo->query('SELECT * FROM tfd102_g3.product;');
$pagecount = $pagecount->rowCount();
$pdata = $pdo->query('SELECT * FROM tfd102_g3.product LIMIT '.(($nowpage-1)*10).',10;');
$pdata = $pdata->fetchAll();
