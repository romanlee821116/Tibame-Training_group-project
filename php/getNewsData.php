...
$pdo = getPDO();
$pagecount = $pdo->query('SELECT * FROM tfd102_g3.news WHERE discount_id IS NULL;');
$pagecount = $pagecount->rowCount();
$ndata = $pdo->query('SELECT * FROM tfd102_g3.news  WHERE discount_id IS NULL LIMIT '.(($nowpage-1)*10).',10;');
